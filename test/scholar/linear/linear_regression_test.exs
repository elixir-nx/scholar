defmodule Scholar.Linear.LinearRegressionTest do
  ...
  describe "fit" do
    test "matches sklearn for shapes {1, 1}, {1, 1} and type {:f, 32}" do
      ...
      %LinearRegression{coefficients: actual} = Scholar.Linear.LinearRegression.fit(a, b)
    ...
    test "matches sklearn for shapes {1, 1}, {1, 1} and type {:f, 32} and sample_weight" do
      a = Nx.tensor([[0.3166404366493225]])
      b = Nx.tensor([[0.6253954172134399]])
      sample_weight = Nx.tensor([0.2065236121416092])
      expected = Nx.tensor([[1.9999998807907104]])
      %LinearRegression{coefficients: actual} = Scholar.Linear.LinearRegression.fit(a, b, sample_weight: sample_weight)
      assert Nx.all_close(expected, actual) == Nx.tensor(1, type: {:u, 8})
    end
