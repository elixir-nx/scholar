defmodule Scholar.Manifold.MDS do
  ...
  ## Examples
      ...
      %Scholar.Manifold.MDS{
        embedding: Nx.tensor(
          [
            [13.072145462036133, -10.424201011657715],
            [5.13038969039917, -2.3412604331970215],
            [-5.6519083976745605, 1.7662441730499268],
            [-12.550626754760742, 10.99921703338623]
          ]
        ),
        stress: Nx.tensor(
          0.369946151971817
  ...
  ## Examples
      ...
      %Scholar.Manifold.MDS{
        embedding: Nx.tensor(
          [
            [9.68245792388916, 9.68245792388916, 9.68245792388916],
