defmodule Scholar.Optimize.GoldenSectionTest do
  ...
  describe "minimize/4" do
    test "minimizes simple parabola" do
      ...
      result = GoldenSection.minimize(0.0, 5.0, fun, tol: 1.0e-5, maxiter: 500)
    ...
    test "minimizes shifted parabola" do
      ...
      result = GoldenSection.minimize(-5.0, 5.0, fun, tol: 1.0e-5, maxiter: 500)
    ...
    test "minimizes sine function" do
      ...
      result =
        GoldenSection.minimize(0.0, 2 * :math.pi(), fun, tol: 1.0e-5, maxiter: 500)
    ...
    test "respects maxiter limit" do
      ...
      result = GoldenSection.minimize(0.0, 100.0, fun, tol: 1.0e-5, maxiter: 5)
    ...
    test "works with jit_apply" do
      ...
      result = Nx.Defn.jit_apply(&GoldenSection.minimize/4, [0.0, 5.0, fun, opts])
    ...
    test "works with tensor bounds" do
      ...
      result = GoldenSection.minimize(a, b, fun)
    ...
    test "achieves higher precision with f64 bounds" do
      ...
      result = GoldenSection.minimize(a, b, fun, tol: 1.0e-10)
