defmodule Scholar.Preprocessing.Normalizer do
  ...
  ## Examples
      ...
      iex> Scholar.Preprocessing.Normalizer.fit(t)
  ...
  ## Examples
      ...
      iex> t = Nx.tensor([[1, -1, 2], [2, 0, 0], [0, 1, -1]])
      iex> scaler = Scholar.Preprocessing.Normalizer.fit(t)
      iex> Scholar.Preprocessing.Normalizer.transform(scaler, t)
      #Nx.Tensor<
        f32[3][3]
        [
      ...
      iex> Scholar.Preprocessing.Normalizer.transform(scaler, new_tensor)
      #Nx.Tensor<
        f32[2][3]
        [
