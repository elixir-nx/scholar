  ...
  * [1] [Tackling the Poor Assumptions of Naive Bayes Text Classifiers](https://cdn.aaai.org/ICML/2003/ICML03-081.pdf)
  ...
  ## Examples
      ...
      #Nx.Tensor<
        f32[2][3]
        [
          [-1.0935745, -1.2837219, -0.946805],
          [-1.1006699, -1.1928024, -1.0106525]
        ]
      >
  """
  ...
  ## Examples
      ...
      #Nx.Tensor<
        f32[2][3]
        [
          [0.33501682, 0.2770044, 0.38797864],
          [0.3326482, 0.3033699, 0.3639814]
        ]
      >
  """
  ...
  ## Examples
      ...
      #Nx.Tensor<
        f32[2][3]
        [
          [13.741782, 13.551635, 13.888552],
          [24.283932, 24.1918, 24.37395]
        ]
      >
  """
