defmodule Scholar.NaiveBayes.Multinomial do
  ...
  ## Examples
      ...
      #Nx.Tensor<
        f32[2][3]
        [
          [-1.1167822, -3.3237486, -0.45153332],
          [-1.141428, -3.0292149, -0.4584179]
        ]
      >
  """
  ...
  ## Examples
      ...
      #Nx.Tensor<
        f32[2][3]
        [
          [0.3273314, 0.036017563, 0.6366512],
          [0.31936264, 0.048353586, 0.6322832]
        ]
      >
  """
  ...
  ## Examples
      ...
      #Nx.Tensor<
        f32[2][3]
        [
          [-14.899698, -17.106665, -14.234449],
          [-25.563969, -27.451756, -24.880959]
        ]
      >
  """
